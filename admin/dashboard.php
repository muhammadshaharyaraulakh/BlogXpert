    ...
    <section id="view-categories" class="hidden">
        ...
        <div class="paragraph-grid">
            ...
            <div class="form__section-container" style="padding: 1.5rem; width: 100%;">
                ...
                <form id="addCategoryForm" action="/admin">
...
<script src="/assests/admin.js"></script>
<script src="/assests/postHandler.js"></script>
<script src="/assests/categoryHandler.js"></script>
<script src="/assests/AdminAndWriterHandler.js"></script>
<script src="/assests/DeleteAdminAndWriter.js"></script>
</body>
</html>